...
public class JUnitReportingRunner extends BlockJUnit4ClassRunner {
	...
	/**
	 * Returns a {@link org.junit.runners.model.Statement}: Call {@link #runChild(Object, org.junit.runner.notification.RunNotifier)}
	...
	protected Statement childrenInvoker(final RunNotifier notifier) {
		return new Statement() {
			...
			public void evaluate() {
				de.codecentric.jbehave.junit.monitoring.JUnitScenarioReporter junitReporter = new de.codecentric.jbehave.junit.monitoring.JUnitScenarioReporter(
